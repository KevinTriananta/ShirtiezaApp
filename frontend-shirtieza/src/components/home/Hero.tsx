      ...
      <div className="absolute inset-0 flex items-end pb-8 sm:items-end sm:pb-10 lg:items-center lg:pb-0">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-[20rem] space-y-3.5 sm:max-w-3xl sm:space-y-7">
            <div className="inline-flex max-w-full items-center gap-2 sm:gap-3 bg-white/10 backdrop-blur-md px-3 sm:px-5 py-2 rounded-full border border-white/10 animate-fade-in-up transition-all duration-500 hover:bg-white/15 hover:border-white/25">
              <span className="flex h-2 w-2 rounded-full bg-white animate-pulse" />
              <p className="text-[8px] sm:text-[10px] font-black uppercase tracking-[0.18em] sm:tracking-[0.4em] text-white truncate">
